    ...
    while seguir:
        try:
            with open("cheques_large.csv", "r") as archivo:
                ...
                estado_cheque = input("Ingresar el estado del cheque ('PENDIENTE', 'APROBADO', 'RECHAZADO')").upper()
                ...
                for fila in lector_csv:
                    ...
                    if not (tipo_cheque == fila[10][0] and fila[8] == dni):
                        cheque_valido = False

                    if fila[9] != estado_cheque:  
                        cheque_valido = False
